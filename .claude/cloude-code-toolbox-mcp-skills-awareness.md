...
_Generated: 2026-05-15T06:24:21.664Z_
...
Workspace `mcp.json` _(folder: testSecurity)_

- **e:\Users\zlfz53\Documents\testSecurity\.mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\zlfz53\.claude.json** — _File exists — no servers defined_
